import {
  ...
  CART_REMOVE_ITEM,
  CART_REMOVE_SHIPPING_ADDRESS, CART_SAVE_PAYMENT_METHOD,
...
const initialState = {
  ...
  checkout: {
    shippingAddress: Storage.has('shippingAddress') ? Storage.get('shippingAddress') : {},
    paymentMethod: Storage.has('paymentMethod') ? Storage.get('paymentMethod') : '',
    checkoutPage: 1,
  },
